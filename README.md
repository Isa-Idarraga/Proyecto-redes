...
| Bi-LSTM Multitarea | 0.486 | 0.672 | — |
| DistilBERT Fine-tuning | **0.549** | **0.601** | — |

DistilBERT supera a los modelos anteriores en predicción de rating con un 20% menos de error (MAE). La tarea de spoiler mostró desbalance de clases severo — el dataset cruzado YA × spoilers contiene muy pocos positivos, lo que colapsa el F1 a cero para los modelos secuenciales.
...
```
ProyectoRedesFinal/
├── 01_eda.ipynb                     # análisis exploratorio + eda_plots.png
├── 02_preprocessing.ipynb           # limpieza, muestreo, emotion labeling
├── 03_baseline_mlp.ipynb            # MLP + TF-IDF
├── 04_bilstm.ipynb                  # Bi-LSTM multitarea
